 ...
 * This class/code is Public Domain (2012). Feel free to do anything you please. 
 * <a href="http://www.noblemaster.com">Noble Master</a>.
 * <a href="http://blog.noblemaster.com/2012/11/01/iso-4217-currency-list-currency-java/">currency list in java</a>.
 * 
 * @author noblemaster (Christoph Aschwanden)
 */
public enum PriceCurrencies 
{
	// @formatter:off
	...
	public String format( long amount ) 
	{
		...
		switch (digits) 
		{
	      	...
	      	default: 
	      		Log.error("Digits not implemented: " + digits);
	      		formatted = String.valueOf(amount);
	  	}
	...
	public static Currency find( Country country ) 
	{
		...
		switch (country) 
		{
			case BO: { return Currency.BOB; }
			case CH: { return Currency.CHF; }
			case CL: { return Currency.CLP; }
			case MX: { return Currency.MXN; }
			case US: { return Currency.USD; }
			case UY: { return Currency.UYU; }
			default: 
			{        
