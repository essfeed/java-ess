 ...
 * In addition, there are static methods to get a Country instance that
 ...
 *
 * Country cc = Country.{@link #getByCode(String) getByCode}("JP");
 *
...
public enum Country
{
    ...
    /**
     * Get a Country that corresponds to a given ISO 3166-1
     ...
     *
     * @return
     *         A Country instance, or null if not found.
     */
    public static Country getByCode( String code )
    {
        ...
        switch ( code.length() )
        {
            case 2:  return getByAlpha2Code( code );
            case 3:  return getByAlpha3Code( code ); 
            default: return null;
        }
    }
    ...
    /**
     * Get a Country that corresponds to a given
